...
const getTestSeriesByGrade = async (grade) => {
  try {
    ...
    const testSeriesQuery = `select Name, Activate_Date, Image as Test_Image, Survey_Link, Subject, Free from Test_Series where Grade like '%${grade}%' order by Activate_Date asc limit 200`;
